...
SCENE_SRCS = Scene.cpp Test.cpp TestSphere.cpp
...
SHADER_SRCS = Shader.cpp
SHADER_INCLUDES = Shader.hpp
SHADER_SRCS_DIR = Shader
SHADER_SRCS_PATH = $(addprefix $(SHADER_SRCS_DIR)/, $(SHADER_SRCS))
SRCS += $(SHADER_SRCS_PATH)
DIRS = $(SHADER_SRCS_DIR)
